###############################################################################################################
## 
## drivy_backend_challenge - level 4
...
class Rental:
    def __init__(self, id, car_id, start_date, end_date, distance):
        ...
        self.driver_price = {}
        self.profit = {}
        self.commission_insurance = {}
        self.commission_assistance = {}
        self.commission_drivy = {}
    ...
    def set_price(self, driver_price):
        ...
        total_comission = int(0.3 * driver_price)
        insurance_fee =  int(0.5 * total_comission)
        assistance_fee = int(100 * self.duration_days)
        drivy_fee = total_comission - insurance_fee - assistance_fee
        profit = driver_price - total_comission
    ...
    for rental in rentals:
        ...
        output_data.append(
            ...
            'actions': [
                rental.driver_price,
                rental.profit, 
                rental.commission_insurance, 
                rental.commission_assistance,
                rental.commission_drivy
                ]
            }
        )
